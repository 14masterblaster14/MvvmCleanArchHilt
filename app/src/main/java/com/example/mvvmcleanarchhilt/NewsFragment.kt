...
import com.example.mvvmcleanarchhilt.databinding.FragmentNewsBinding
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner,{response ->
            when(response){
                is Resource.Success -> {
                    hideProgressBar()
                    response.data?.let {
                        Log.i("MyTag","Response data :-> $it")
                        newsAdapter.differ.submitList(it.articles.toList())
                        Log.i("MyTag","newsAdapter.differ.currentList -> ${newsAdapter.differ.currentList}")
                        // Checking if current page is last page or not
